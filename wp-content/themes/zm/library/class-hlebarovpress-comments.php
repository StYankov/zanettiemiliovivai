...
/**
 * HlebarovPress Comments
 *
 * @package HlebarovPress
 */

if (!class_exists('hlebarovpress_Comments')) :
	class hlebarovpress_Comments extends Walker_Comment
	{
		...
		{ ?>
			...
			<h3><?php comments_number(__('No Responses to', 'hlebarovpress'), __('One Response to', 'hlebarovpress'), __('% Responses to', 'hlebarovpress')); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
					...
					<article id="comment-body-<?php comment_ID(); ?>" class="comment-body">
						...
						<header class="comment-author">
							...
							<div class="author-meta vcard author">
								...
								printf(
									__('<cite class="fn">%s</cite>', 'hlebarovpress'),
						...
						<section id="comment-content-<?php comment_ID(); ?>" class="comment">
							<?php if (!$comment->comment_approved) : ?>
								<div class="notice">
									<p class="bottom"><?php _e('Your comment is awaiting moderation.', 'hlebarovpress'); ?></p>
								</div>
