 ...
 * @since HlebarovPress 1.1.0
 */

if (!class_exists('hlebarovpress_Protocol_Relative_Theme_Assets')) :
	class hlebarovpress_Protocol_Relative_Theme_Assets
	{
		/**
	...
	$hlebarovpress_protocol_relative_theme_assets = new hlebarovpress_Protocol_Relative_Theme_Assets;
endif;
