...
if (!function_exists('hlebarovpress_pagination')) :
	function hlebarovpress_pagination()
	{
		global $wp_query;
...
if (!function_exists('hlebarovpress_get_the_comments_pagination')) :
	function hlebarovpress_get_the_comments_pagination($args = array())
	{
		$navigation = '';
		$args = wp_parse_args($args, array(
			'prev_text'				=> __('&laquo;', 'hlebarovpress'),
			'next_text'				=> __('&raquo;', 'hlebarovpress'),
			'size'					=> 'default',
			'show_disabled'			=> true,
		));
		$args['type'] = 'array';
...
// Custom Comments Pagination.
if (!function_exists('hlebarovpress_the_comments_pagination')) :
	function hlebarovpress_the_comments_pagination($args = array())
	{
		echo hlebarovpress_get_the_comments_pagination($args);
	}
endif;
...
if (!function_exists('hlebarovpress_menu_fallback')) :
	function hlebarovpress_menu_fallback()
	{
		echo '<div class="alert-box secondary">';
		/* translators: %1$s: link to menus, %2$s: link to customize. */
		printf(
			__('Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'hlebarovpress'),
			/* translators: %s: menu url */
			sprintf(
				__('<a href="%s">Menus</a>', 'hlebarovpress'),
				get_admin_url(get_current_blog_id(), 'nav-menus.php')
			),
			/* translators: %s: customize url */
			sprintf(
				__('<a href="%s">Customize</a>', 'hlebarovpress'),
...
if (!function_exists('hlebarovpress_active_nav_class')) :
	function hlebarovpress_active_nav_class($classes, $item)
	{
	...
	add_filter('nav_menu_css_class', 'hlebarovpress_active_nav_class', 10, 2);
endif;
 ...
 */
if (!function_exists('hlebarovpress_active_list_pages_class')) :
	function hlebarovpress_active_list_pages_class($input)
	{
	...
	add_filter('wp_list_pages', 'hlebarovpress_active_list_pages_class', 10, 2);
endif;
...
if (!function_exists('hlebarovpress_mobile_menu_id')) :
	function hlebarovpress_mobile_menu_id()
	{
...
if (!function_exists('hlebarovpress_title_bar_responsive_toggle')) :
	function hlebarovpress_title_bar_responsive_toggle()
	{
 ...
 */
if (!function_exists('hlebarovpress_gallery')) :
	function hlebarovpress_gallery($attr)
	{
	...
	add_shortcode('gallery', 'hlebarovpress_gallery');
endif;
