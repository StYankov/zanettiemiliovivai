...
<div class="cart-main">
    <div class="page-header">
        <div class="container-constrained">
            <h1 class="text current h1">Shopping Cart</h1>
            <i class="fa-solid fa-right-long"></i>
            <h2 class="text h1">Checkout</h2>
            <i class="fa-solid fa-right-long"></i>
            <h2 class="text h1">Order Complete</h2>
        </div>
    </div>

    <div class="grid-x container-constrained grid-margin-x">
